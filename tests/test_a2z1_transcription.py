...
def test_cfg_rows():
    ...
    # r1/r2 post-mortem deltas (2026-07-19): die-fast basin fixes
    check("L1 phase-in spawn moderation (roll/pitch ±0.15)",
          '"roll": (-0.15, 0.15)' in e and '"z": (0.0, 0.1)' in e)
    check("termination penalty dt-corrected (−250 × 0.02 = −5/death)",
          "termination_penalty" in e and "is_terminated" in e and "weight=-250.0" in e)
    check("alive bonus present (+0.15/step, phase-in crutch)",
          "alive_bonus" in e and "is_alive" in e and "weight=7.5" in e)
